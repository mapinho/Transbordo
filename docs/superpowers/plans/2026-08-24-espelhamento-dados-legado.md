...
- **`USE_TZ = True` e `TIME_ZONE = 'America/Sao_Paulo'`.** Os datetimes do legado são naive; precisam virar aware antes de serem escritos, ou Django os interpreta como UTC e desloca tudo em 3 horas.
